...
Messages.cat_dir_exists = "Directory {} exists; some of its files may " \
    "be overwritten"
Config.instname = "King's College London"
Config.profilename = "KCL Eduroam"
Config.url = "your local eduroam® support page"
Config.email = "8888@kcl.ac.uk"
Config.title = "eduroam CAT"
Config.server_match = "login.kcl.ac.uk"
...
Config.user_realm = "kcl.ac.uk"
Config.ssids = ['eduroam']
Config.del_ssids = []
Config.servers = ['DNS:login.kcl.ac.uk']
